        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("pattern") !== undefined) {
              message = "Not in the expected format<!-- output-validation-pattern-message to override -->";
            ...
            if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
              ...
              message = "Too high: Maximum of '" + max + "'<!-- output-validation-max-message to override -->";
            ...
            if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
              ...
              message = "Too low: Minimum of '" + min + "'<!-- output-validation-min-message to override -->";
            ...
            if ($this.attr("maxlength") !== undefined) {
              message = "Too long: Maximum of '" + $this.attr("maxlength") + "' characters<!-- output-validation-maxlength-message to override -->";
            ...
            if ($this.attr("minlength") !== undefined) {
              message = "Too short: Minimum of '" + $this.attr("minlength") + "' characters<!-- output-validation-minlength-message to override -->";
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Not a valid email address<!-- output-validation-email-message to override -->";
            ...
            if ($this.attr("minchecked") !== undefined) {
              message = "Not enough options checked; Minimum of '" + $this.attr("minchecked") + "' required<!-- output-validation-minchecked-message to override -->";
            ...
            if ($this.attr("maxchecked") !== undefined) {
              message = "Too many options checked; Maximum of '" + $this.attr("maxchecked") + "' required<!-- output-validation-maxchecked-message to override -->";
          ...
          // Get extra ones defined on the element's output attributes
          ...
          $.each(validatorNames, function (i, el) {
            ...
            if (!message) {
              message = "'" + el + "' validation failed <!-- Add attribute 'output-validation-" + el.toLowerCase() + "-message' to input to change this message -->";
            }
      ...
      number: {
		...
		builtInValidators: {
			...
			passwordagain: {
				...
				type: "match",
				match: "password",
				message: "Does not match the given password<!-- output-validator-paswordagain-message to override -->"
			},
			positive: {
				name: "Positive",
				type: "shortcut",
			...
			integer: {
				...
				type: "regex",
				regex: "[+-]?\\d+",
				message: "No decimal places allowed<!-- output-validator-integer-message to override -->"
			},
			positivenumber: {
				name: "Positivenumber",
				type: "min",
				min: 0,
				message: "Must be a positive number<!-- output-validator-positivenumber-message to override -->"
			},
			negativenumber: {
				name: "Negativenumber",
				type: "max",
				max: 0,
				message: "Must be a negative number<!-- output-validator-negativenumber-message to override -->"
			},
			required: {
				name: "Required",
				type: "required",
				message: "This is required<!-- output-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
				minchecked: 1,
				message: "Check at least one option<!-- output-validation-checkone-message to override -->"
			},
      number: {
        name: "Number",
        type: "number",
